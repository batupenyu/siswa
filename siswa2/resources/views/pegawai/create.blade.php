                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="pangkat" id="pangkat" class="form-control @error('pangkat') is-invalid @enderror" value="{{ old('pangkat') }}">
                            @error('pangkat')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="integrasi" id="integrasi" class="form-control @error('integrasi') is-invalid @enderror" value="{{ old('integrasi') }}">
                            @error('integrasi')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="no_karpeg" id="no_karpeg" class="form-control @error('no_karpeg') is-invalid @enderror" value="{{ old('no_karpeg') }}">
                            @error('no_karpeg')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tgl_tmt_jabatan" id="tgl_tmt_jabatan" class="form-control @error('tgl_tmt_jabatan') is-invalid @enderror" value="{{ old('tgl_tmt_jabatan') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" name="tgl_tmt_pangkat" id="tgl_tmt_pangkat" class="form-control @error('tgl_tmt_pangkat') is-invalid @enderror" value="{{ old('tgl_tmt_pangkat') }}">
