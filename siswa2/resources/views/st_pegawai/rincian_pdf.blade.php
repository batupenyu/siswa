...
<table >
    ...
    <tr>
        <td>SPPD No.</td>
        <td style="width: 20px">:</td>
        <td>800/ ........... /SMKN 1 Kb/DINDIK/{{ Carbon\Carbon::parse($stPegawai->tgl_sppd)->translatedFormat('Y') }}</td>
    </tr>
    <tr>
        <td>Tgl. SPPD.</td>
        <td style="width: 20px">:</td>
...
<table border="1" style="width: 100%; font-size: 11pt; border-collapse: collapse; border: 1px solid black;" cellpadding="3">
        ...
        <td>
            <table border="0">
                <tr>
                    ...
                    <td style="width: 20px">{{ $stPegawai->biaya_transportasi > 0 ? $stPegawai->pegawais->count():'' }}</td>
                    ...
                    <td style="text-align: right; width:60px ">
                        @if ($stPegawai->biaya_transportasi <=0)
                        @else
                            @if ($stPegawai->pegawais->isNotEmpty())
                            {{ number_format($totalTransport = $stPegawai->biaya_transportasi * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->biaya_penginapan <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->biaya_penginapan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->biaya_tiket <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->biaya_tiket * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->transport_lokal <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->transport_lokal * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->uang_makan <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->uang_makan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->uang_saku <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->uang_saku * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->uang_representasi <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->uang_representasi * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right">
                        @if ($stPegawai->uang_kediklatan <=0)
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTransport = $stPegawai->uang_kediklatan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
            ...
            <table border="0" >
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalPenginapan = $stPegawai->biaya_penginapan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->biaya_tiket * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->transport_lokal * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->uang_makan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->uang_saku * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->uang_representasi * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;width:60px">
                        ...
                        @else
                            @if ($stPegawai->pegawais->count() !=0)
                            {{ number_format($totalTiket = $stPegawai->uang_kediklatan * $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') }}
                            @else
                            @endif
                        @endif
                    </td>
        ...
        <td style="vertical-align: top">
            <table border="0" style="font-size: 10pt" >
                <tr>
                    ...
                    <td style="width: 20px">:</td>
                    <td style="width: 75px; vertical-align:top"> {{ \Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1 }} 
                        @php
...
<table  >
    ...
    <tr>
        ...
        <td style="text-align: right; width:70px">{{ number_format($totalSeluruh = ($stPegawai->biaya_transportasi + $stPegawai->biaya_penginapan + $stPegawai->biaya_tiket + $stPegawai->transport_lokal + $stPegawai->uang_makan + $stPegawai->uang_saku + $stPegawai->uang_representasi + $stPegawai->uang_kediklatan)* $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') , 0, ',', '.' }} </td>
    </tr>
    <tr>
