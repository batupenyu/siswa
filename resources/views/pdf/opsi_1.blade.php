<tr>
    ...
    <td></td>
    <td></td>
    <td style="text-align: right; padding-right:60px">{{ number_format((float)$akKredits_first->pegawai->integrasi,3) }}</td>
</tr>
...
<tr >
    ...
    <td style="text-align: right; padding-right:60px">{{ number_format($totalAkKredit + (float)$akKredits_first->pegawai->integrasi, 3) }}</td>
</tr>