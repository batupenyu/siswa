...
<div class="container">
    ...
    <form action="{{ route('ipps.store') }}" method="POST">
        ...
        <div class="form-group mt-3">
            ...
            <input type="number" name="nominal" id="nominal" class="form-control" value="{{ old('nominal') }}" required step="0.01" min="0" />
        </div>
        ...
        <div class="form-group mt-3">
            ...
            <input type="text" name="tempat_ditetapkan" id="tempat_ditetapkan" class="form-control" value="{{ old('tempat_ditetapkan') }}" />
        </div>
