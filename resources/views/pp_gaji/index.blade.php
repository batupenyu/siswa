...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                <td>{{ $ppGaji->id }}</td>
                <td>{{ $ppGaji->description }}</td>
                <td>
                    <a href="{{ route('pp_gaji.show', $ppGaji->id) }}" class="btn btn-info btn-sm">View</a>
                    <a href="{{ route('pp_gaji.edit', $ppGaji->id) }}" class="btn btn-warning btn-sm">Edit</a>
