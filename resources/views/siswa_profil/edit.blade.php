            ...
            <div class="row">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <select name="jenis_kelamin" class="form-control">
                                ...
                                <option value="L" {{ old('jenis_kelamin', $siswaProfil->jenis_kelamin) == 'L' ?
                                    'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('jenis_kelamin', $siswaProfil->jenis_kelamin) == 'P' ?
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="tempat_tanggal_lahir" class="form-control"
                                value="{{ old('tempat_tanggal_lahir', $siswaProfil->tempat_tanggal_lahir) }}">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8">
                            <select name="status_anak" class="form-control">
                                ...
                                <option value="piatu" {{ old('status_anak', $siswaProfil->status_anak) == 'piatu' ?
                                    'selected' : '' }}>Piatu</option>
                                <option value="yatim-piatu" {{ old('status_anak', $siswaProfil->status_anak) ==
                                    'yatim-piatu' ? 'selected' : '' }}>Yatim Piatu</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <select name="tinggal_dengan" class="form-control">
                                <option value="">-- Select --</option>
                                <option value="orang_tua" {{ old('tinggal_dengan', $siswaProfil->tinggal_dengan) ==
                                    'orang_tua' ? 'selected' : '' }}>Orang Tua</option>
                                <option value="saudara" {{ old('tinggal_dengan', $siswaProfil->tinggal_dengan) ==
                                    'saudara' ? 'selected' : '' }}>Saudara</option>
                                <option value="di_asrama" {{ old('tinggal_dengan', $siswaProfil->tinggal_dengan) ==
                                    'di_asrama' ? 'selected' : '' }}>Di Asrama</option>
                                <option value="kos" {{ old('tinggal_dengan', $siswaProfil->tinggal_dengan) == 'kos' ?
                                    'selected' : '' }}>Kos</option>
                            </select>
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kelainan_jasmani" class="form-control"
                                value="{{ old('kelainan_jasmani', $siswaProfil->kelainan_jasmani) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="tinggi_dan_berat_badan" class="form-control"
                                value="{{ old('tinggi_dan_berat_badan', $siswaProfil->tinggi_dan_berat_badan) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="pendidikan_sebelumnya" class="form-control"
                                value="{{ old('pendidikan_sebelumnya', $siswaProfil->pendidikan_sebelumnya) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lulusan_dari" class="form-control"
                                value="{{ old('lulusan_dari', $siswaProfil->lulusan_dari) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="tanggal_dan_nomor_sttb" class="form-control"
                                value="{{ old('tanggal_dan_nomor_sttb', $siswaProfil->tanggal_dan_nomor_sttb) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="lama_belajar" class="form-control"
                                value="{{ old('lama_belajar', $siswaProfil->lama_belajar) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="dari_sekolah" class="form-control"
                                value="{{ old('dari_sekolah', $siswaProfil->dari_sekolah) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alasan_pindah"
                                class="form-control">{{ old('alasan_pindah', $siswaProfil->alasan_pindah) }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="diterima_di_sekolah_ini" class="form-control"
                                value="{{ old('diterima_di_sekolah_ini', $siswaProfil->diterima_di_sekolah_ini) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="di_kelas" class="form-control"
                                value="{{ old('di_kelas', $siswaProfil->di_kelas) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="tanggal_diterima" class="form-control"
                                value="{{ old('tanggal_diterima', $siswaProfil->tanggal_diterima) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kesenian_kegemaran_siswa" class="form-control"
                                value="{{ old('kesenian_kegemaran_siswa', $siswaProfil->kesenian_kegemaran_siswa) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="olahraga_kegemaran_siswa" class="form-control"
                                value="{{ old('olahraga_kegemaran_siswa', $siswaProfil->olahraga_kegemaran_siswa) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kegiatan_kemasyarakatan_kegemaran_siswa" class="form-control"
                                value="{{ old('kegiatan_kemasyarakatan_kegemaran_siswa', $siswaProfil->kegiatan_kemasyarakatan_kegemaran_siswa) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kegemaran_lain_lain" class="form-control"
                                value="{{ old('kegemaran_lain_lain', $siswaProfil->kegemaran_lain_lain) }}">
                        </div>
                    </div>
