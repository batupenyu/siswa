        ...
        <form action="{{ route('siswa-profil.store') }}" method="POST">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tempat_lahir" class="col-sm-4 col-form-label text-end">Tempat Tanggal
                            Lahir</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tanggal_lahir" class="col-sm-4 col-form-label text-end">Tanggal
                            Lahir</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <select name="tinggal_dengan" class="form-control">
                                <option value="">-- Select --</option>
                                <option value="orang tua" {{ old('tinggal_dengan')=='orang tua' ? 'selected' : '' }}>
                                    Orang Tua</option>
                                <option value="menumpang" {{ old('tinggal_dengan')=='menumpang' ? 'selected' : '' }}>
                                    Menumpang
                                </option>
                                <option value="di asrama" {{ old('tinggal_dengan')=='di asrama' ? 'selected' : '' }}>Di
                                    Asrama</option>
                                <option value="kost" {{ old('tinggal_dengan')=='kost' ? 'selected' : '' }}>Kost</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="alat_transportasi_ke_sekolah" class="form-control"
                                value="{{ old('alat_transportasi_ke_sekolah') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="asal_SD" class="form-control" value="{{ old('asal_SD') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="nomor_sttb_SD" class="form-control"
                                value="{{ old('nomor_sttb_SD') }}">
                        </div>
                    </div>
                    <div class="form-group row align-items-center">
                        <label for="tanggal_sttb_SD" class="col-sm-4 col-form-label text-end">Tanggal STTB SD</label>
                        <div class="col-sm-8">
                            <input type="date" name="tanggal_sttb_SD" class="form-control"
                                value="{{ old('tanggal_sttb_SD') }}">
                        </div>
                    </div>

                    <div class="form-group row align-items-center">
                        <label for="lama_belajar_SD" class="col-sm-4 col-form-label text-end">Lama Belajar SD</label>
                        <div class="col-sm-8">
                            <input type="text" name="lama_belajar_SD" class="form-control"
                                value="{{ old('lama_belajar_SD') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="asal_SMP" class="form-control" value="{{ old('asal_SMP') }}">
                        </div>
                    </div>

                    <div class="form-group row align-items-center">
                        <label for="tanggal_sttb_SMP" class="col-sm-4 col-form-label text-end">
                            Nomor STTB SMP</label>
                        <div class="col-sm-8">
                            <input type="text" name="tanggal_sttb_SMP" class="form-control"
                                value="{{ old('tanggal_sttb_SMP') }}">
                        </div>
                    </div>

                    <div class="form-group row align-items-center">
                        <label for="tanggal_sttb_SMP" class="col-sm-4 col-form-label text-end">Tanggal STTB SMP</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="lama_belajar_SMP" class="col-sm-4 col-form-label text-end">Lama Belajar SMP</label>
                        <div class="col-sm-8">
                            <input type="text" name="lama_belajar_SMP" class="form-control"
                                value="{{ old('lama_belajar_SMP') }}">
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tempat_lahir_ayah" class="col-sm-4 col-form-label text-end">Tempat Tanggal
                            Lahir Ayah</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tanggal_lahir_ayah" class="col-sm-4 col-form-label text-end"> Tanggal
                            Lahir Ayah</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alamat_ayah" class="form-control">{{ old('alamat_ayah') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="penghasilan_perbulan_ayah" class="form-control"
                                value="{{ old('penghasilan_perbulan_ayah') }}">
                        </div>
                    </div>

                    <div class="form-group row align-items-center">
                        <label for="pendidikan_ayah" class="col-sm-4 col-form-label text-end">Pendidikan Ayah</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tempat_lahir_ibu" class="col-sm-4 col-form-label text-end">Tempat Tanggal
                            Lahir Ibu</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        <label for="tanggal_lahir_ibu" class="col-sm-4 col-form-label text-end">Tanggal
                            Lahir Ibu</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alamat_ibu" class="form-control">{{ old('alamat_ibu') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="penghasilan_perbulan_ibu" class="form-control"
                                value="{{ old('penghasilan_perbulan_ibu') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <textarea name="alamat_wali" class="form-control">{{ old('alamat_wali') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kegemaran_kemasyarakatan" class="form-control"
                                value="{{ old('kegemaran_kemasyarakatan') }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="kegemaran_hasta_karya" class="form-control"
                                value="{{ old('kegemaran_hasta_karya') }}">
                        </div>
                    </div>
