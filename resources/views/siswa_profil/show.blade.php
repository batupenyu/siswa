...
<body>
    <div class="container">
        <h2>FORMULIR PENDAFTARAN<br><u>SMK NEGERI 1 KOBA TAHUN PELAJARAN 2026/2027</u></h2>
        <br>
        @php
        ...
        <table>
            <tr >
                ...
                <td>:</td>
                <td>{{ \Illuminate\Support\Str::title($siswaProfil->nama_lengkap ?? '') }}</td>
            </tr>
            <tr >
            ...
            <tr >
                <td>6. Anak ke-</td>
                <td>:</td>
                <td>{{ isset($siswaProfil->anak_ke_berapa) ? number_format($siswaProfil->anak_ke_berapa, 0, ',', '.') : '' }}</td>
            </tr>
            <tr >
        ...
        <table>
            <tr >
                ...
                <td>:</td>
                <td style="padding-left: 20px;">{{ \Illuminate\Support\Str::title($siswaProfil->alamat ?? '') }}</td>
            </tr>
            <tr >
            ...
            <tr >
                ...
                <td>:</td>
                <td><!-- No field found for this, keep empty or add if available --></td>
            </tr>
        </table>
        ...
        <table>
            <tr >
                ...
                <td>:</td>
                <td>{{ $siswaProfil->berat_badan ?? '...' }} kg, {{$siswaProfil->tinggi_badan ?? '...'}} cm</td>
            </tr>
            <tr >
        ...
        <table>
            <tr >
                ...
                <td>:</td>
                <td>{{ \Illuminate\Support\Str::upper($siswaProfil->asal_SD ?? '') }}</td>
            </tr>
            <tr >
                <td style="padding-left: 12px;">a. Tanggal dan Nomor STTB/Ijazah</td>
                <td>:</td>
                <td>{{ $siswaProfil->nomor_sttb_SD ?? '' }}/ {{ tryParseDate($siswaProfil->tanggal_sttb_SD ?? '') }}</td>
            </tr>
            <tr >
            ...
            <tr >
                <td style="padding-left: 12px;">a. Tanggal dan Nomor STTB/Ijazah</td>
                <td>:</td>
                <td>{{ $siswaProfil->nomor_sttb_SMP ?? '' }} / {{ tryParseDate($siswaProfil->tanggal_sttb_SMP ?? '') }}</td>
            </tr>
            <tr >
                <td style="padding-left: 12px;">b. Lama Belajar</td>
                <td>:</td>
        ...
        <table>
            <tr>
                ...
                <td>:</td>
                <td>{{ \Illuminate\Support\Str::title($siswaProfil->kegemaran_olah_raga ?? '') }}</td>
            </tr>
            <tr >
        ...
        <ol style="margin-left: 0px; text-align: justify;">
            <li>Saya dengan sadar dan tanpa paksaan dari pihak manapun bersungguh-sungguh untuk mendaftar sebagai
                Peserta Didik SMK
                Negeri 1 Koba Tahun Pelajaran 2026/2027 serta mengikuti dan mentaati dengan sungguh-sungguh setiap
