...
@section('content')
<div class="container">
    <h1>Tambah Sisa Cuti</h1>

    <form action="{{ route('sisa_cuti.store') }}" method="POST">
        @csrf
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="number" name="sisa_tahun_n" id="sisa_tahun_n" class="form-control" value="{{ old('sisa_tahun_n') }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="number" name="sisa_tahun_n_1" id="sisa_tahun_n_1" class="form-control" value="{{ old('sisa_tahun_n_1') }}" required>
            </div>
        </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input type="number" name="sisa_tahun_n_2" id="sisa_tahun_n_2" class="form-control" value="{{ old('sisa_tahun_n_2') }}" required>
            </div>
        </div>
