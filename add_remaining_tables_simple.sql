...
-- Add nama_kegiatan column to surat table if it doesn't exist (will fail if exists, which is OK)
ALTER TABLE surat ADD COLUMN nama_kegiatan VARCHAR(255) NULL DEFAULT NULL;

-- Add file column to surat table if it doesn't exist (will fail if exists, which is OK)
