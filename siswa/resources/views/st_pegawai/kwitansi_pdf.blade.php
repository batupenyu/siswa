...
<table style="border-collapse: collapse; font-size:11pt;width:95%" class="table-borderless">
    <tr>
        <td rowspan="2" style="vertical-align: bottom;border-right: 1px solid black;border-top: 1px solid black; padding:5px">
            <i>Diperiksa Oleh :</i></td>
        <td style="vertical-align: top;border-top: 1px solid black; padding:5px">Sudah terima dari</td>
        <td style="width:15px;border-top: 1px solid black; vertical-align:top;padding:5px">:</td>
        <td colspan="3" style="width: 525px; text-align:justify;border-top: 1px solid black; padding:5px; vertical-align:top">Pengguna Anggaran/Kuasa Pengguna Anggaran Bendahara Pengeluaran Pembantu Cabang Dinas Pendidikan Wilayah I Provinsi Kepulauan Bangka Belitung. Satker Cabang Dinas Pendidikan Wil. I Provinsi Kepulauan Bangka Belitung.</td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td></td>
        <td></td>
        <td style="text-align: center"> Koba, {{ Carbon\Carbon::parse($stPegawai->tglKwitansi)->translatedFormat('d F Y') }}  </td>
    </tr>
    <tr>
                    ...
                    <td>
                        <table border="1">
                            <tr>
                                ...
                                <td style="width: 100px; text-align:right"><b><i>{{ number_format($totalSeluruh = ($stPegawai->biaya_transportasi + $stPegawai->biaya_penginapan + $stPegawai->biaya_tiket + $stPegawai->transport_lokal + $stPegawai->uang_makan + $stPegawai->uang_saku + $stPegawai->uang_representasi + $stPegawai->uang_kediklatan)* $stPegawai->pegawais->count() * (\Carbon\Carbon::parse($stPegawai->tgl_awal)->diffInDays($stPegawai->tgl_akhir) + 1), 0, ',', '.') , 0, ',', '.' }},-</i></b></td>
                            </tr>
                        </table>
                    </td>
                </tr>
